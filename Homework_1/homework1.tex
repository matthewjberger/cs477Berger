...
\begin{homeworkProblem}[5]
    ...
    \begin{enumerate}[label=\alph*)]
    	\item \(0 \leq 5n^2 + 20 \leq cn^2  \rightarrow c \geq \frac{20}{n^2} + 5\ \text{and}\ n_0 \geq 1 \\ \therefore c = 25\ \text{and}\ n_0=1\ \text{and}\ 5n + 20 \in \bigo(n^2)\)
    	\item \(0 \leq n + 23 \leq cn^3 \rightarrow c \geq \frac{n+23}{n^3}\ \text{and}\ n_0 \geq 1 \\ \therefore c = 24\ \text{and}\ n_0=1\ \text{and}\ n + 23 \in \bigo(n^3)\)
    \end{enumerate}
\end{homeworkProblem}
