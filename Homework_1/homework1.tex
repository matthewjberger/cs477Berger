...
\begin{homeworkProblem}
    ...
    \begin{enumerate}[label=\alph*)]
    	\item \(\sum\limits_{i=1}^n i^3=\lbrack \frac{n(n+1)}{2}\rbrack^2\)
    	\item \(\sum\limits_{i=1}^ni(i+1)=\frac{n(n+1)(n+2)}{3}\)
    \end{enumerate}
...
\begin{homeworkProblem}[5]
    ...
    \begin{enumerate}[label=\alph*)]
    	\item \(5n^2 + 20 \in \mathcal{O}(n^2)\)
    	\item \(n + 23 \in \mathcal{O}(n^3)\)
    \end{enumerate}
