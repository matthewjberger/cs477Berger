...
\begin{homeworkProblem}[3]
	\textbf{Extra Credit: [20 points]} Indicate whether the following statements are true or false and justify your answers.
	\begin{enumerate}[label=\alph*.)]
		\item  If X and Y are sequences that both begin with the character A, every longest common
subsequence of X and Y begins with A.
		\item If X and Y are sequences that both end with the character A, some longest common
